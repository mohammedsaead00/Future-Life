...
builder.Services.AddHostedService<MonthlyEmailJob>();
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "FutureLife API",
        Version = "v1",
        Description = "Life simulation and financial planning REST API"
    });
...
if (app.Environment.IsDevelopment() || builder.Environment.IsProduction())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "FutureLife API v1");
